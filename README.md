...
- **הצעות חיפוש קשורות** — תוך כדי הקלדה מופיעות הצעות של מילים נרדפות ומושגים קשורים (למשל "שוטה" → כסיל, טיפש; "מנורת לילה בשבת" → חשמל בשבת); לחיצה מרחיבה את החיפוש, מקומי וללא אינטרנט. המילון מתעדכן אוטומטית ברקע
- **תיקון מקלדת אנגלית (חדש)** — אם הקלדת מילה עברית כשהמקלדת באנגלית (יצא ג'יבריש כמו "akuo"), התוכנה מזהה ומחפשת את המילה כפי שהתכוונת ("שלום"), עם הערה שתורגם
